...
{
    public const AUTHORIZE_URL_FORMAT = 'https://{shop_domain}/admin/oauth/authorize?client_id={api_key}&scope={scopes}&redirect_uri={redirect_uri}&state={state}';

    public const ACCESS_TOKEN_URL_FORMAT = 'https://{shop_domain}/admin/oauth/access_token';
     ...
     */
    public function __construct(string $shop_domain, string $api_key, string $shared_secret, array $opts = [])
    {
     ...
     *
     * @see https://docs.shopify.com/api/authentication/oauth#verification @endlink
     */
